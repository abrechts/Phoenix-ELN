...
Public Class FlowSchemeElement
    ...
    '    Dim upstrCtrl As New FlowSchemeElement
    '    With upstrCtrl
    ...
    '''' <returns>Newly create downstream FlowSchemeElement control</returns>
    '''' 
    'Public Function AddDownstreamSequences(sequences As List(Of SequenceBoundingResult), Optional convergingSequence As SequenceBoundingResult = Nothing) As FlowSchemeElement
    ...
    Public Class FlowSchemeDownstreamAdorners
        ...
        Dim mFlowElement As FlowSchemeElement
        Dim mDownstreamPanel As StackPanel
